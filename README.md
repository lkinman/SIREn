...
```
siren eval_model --voldir cnn_outputs --normalize_csv cnn_outputs/map_stats_downsampled.csv --labels labels.csv --weights weights_5e6.pth --batch_size 4 --outdir cnn_outputs
```
