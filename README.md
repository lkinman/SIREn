...
```
siren eval_model --voldir cnn_outputs --normalize_csv cnn_outputs/map_stats_downsampled.csv --labels labels.csv --weights weights.pth --batch_size 4 --outdir cnn_outputs
```
...
siren fine_tune --voldir cnn_outputs --labels_csv normalized_labels.csv --num_epochs 5 --weights weights.pth --outdir fine_tuned_cnn
...
```  
 ...
 ```
siren expand_communties --config 01_sire/00_sketch/config.pkl --blockdir 01_siren/00_sketch --threads 20
