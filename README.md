...
```
siren eval_model -vol_dir cnn_outputs -normalize_csv cnn_outputs/map_stats_downsampled.csv -labels labels.csv -weights weights.pth -batch_size 4 -outdir cnn_outputs
```
...
siren fine_tune -voldir cnn_outputs -labels_csv labels.csv -num_epochs 5 -weights weights.pth -outdir fine_tuned_cnn
